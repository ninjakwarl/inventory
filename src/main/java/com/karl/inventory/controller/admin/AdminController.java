package com.karl.inventory.controller.admin;

import com.karl.inventory.entity.Invoice;
import com.karl.inventory.entity.Product;
import com.karl.inventory.model.InvoiceModel;
...
public class AdminController implements Initializable {
    ...
    private void loadProductsChart() {
        ...
        for (Product p : productModel.getProducts()) {
            series.getData().add(new XYChart.Data(p.getDescription(), p.getQuantity()));
            lists.add(p.getDescription());
        }
