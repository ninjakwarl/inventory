package com.karl.inventory.controller.sales;

import com.karl.inventory.entity.Sale;
import com.karl.inventory.interfaces.SaleInterface;
import com.karl.inventory.model.SalesModel;
import java.net.URL;
...
public class SalesController implements Initializable, SaleInterface {
    ...
    public void deleteAction(ActionEvent event) throws Exception {
        ...
        if (result.get() == ButtonType.OK) {
            Sale selectedSales = salesTable.getSelectionModel().getSelectedItem();

            model.deleteSale(selectedSales);
            SALELIST.remove(selectedSales);
        }
